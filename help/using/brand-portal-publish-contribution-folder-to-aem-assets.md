...
1. Sélectionnez un dossier de contribution dans le tableau de bord Brand Portal.
...
1. Cliquez sur le dossier de contribution pour l’ouvrir. Vous pouvez voir deux sous-dossiers : **[!UICONTROL SHARED]** et **[!UICONTROL NEW]** dans le dossier de contribution. Le dossier SHARED contient toutes les ressources de base (contenu de référence) partagées par les administrateurs.
1. Vous pouvez télécharger sur votre ordinateur local le dossier **[!UICONTROL SHARED]** contenant toutes les ressources de base.
Vous pouvez également ouvrir le dossier **[!UICONTROL SHARED]** et cliquer sur l’icône **Télécharger** pour télécharger des fichiers/dossiers individuels.
