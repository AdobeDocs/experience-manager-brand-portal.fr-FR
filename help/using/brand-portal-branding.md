...
1. Pour ajouter une nouvelle image d’arrière-plan, cliquez sur l’icône **[!UICONTROL Choisir l’image]** dans la barre d’outils supérieure.
   ...
   * Pour télécharger une image depuis votre ordinateur, cliquez sur **[!UICONTROL Télécharger]**. Accédez à l’image requise et téléchargez-la.
   * Pour utiliser une image Brand Portal existante, cliquez sur **[!UICONTROL Sélectionner parmi existants]**. Sélectionnez une image à l’aide du sélecteur de ressource.
...
1. Pour transférer une image d’en-tête, cliquez sur l’icône **[!UICONTROL Choisir l’image]** et sélectionnez ensuite **[!UICONTROL Télécharger]**.
