...
**Réponse.** Tout utilisateur AEM autorisé à créer un dossier dans AEM Assets peut créer un dossier **de contributions** . Pour créer un dossier **de contribution** , créez un nouveau dossier de type Contribution ****du fichier.
Ce dossier est partagé avec les utilisateurs actifs du portail de marque pour contribution.
...
**Question.  Puis-je modifier le nom d’un dossier de contributions existant ?**

**Réponse.** **Non**, vous ne pouvez pas modifier le nom d’un dossier de **contributions** existant.
